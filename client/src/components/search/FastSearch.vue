          ...
          <v-col cols="12" md="9" lg="8">
            <ul>
              <li>
                ...
                wildcard use asterisk (<b class="primary--text">*</b>).
              </li>
              ...
              <li>
                ...
                with '<b class="primary--text">+</b>'. To exclude a term,
                precede it with '<b class="primary--text">-</b>'. For instance:
                <b class="primary--text">+scolecodonts +valga -conjungaspis</b>.
              </li>

              <li>
                To search exact expression, use
                <b class="primary--text">double quotation marks</b>. Use them
                also if the term includes special characters like '+' or '-',
                for instance: <b class="primary--text">"OM6-3"</b>.
              </li>

              <li>
                Quick search box can also be used for more advanced queries, if
                you know names of database fields. For example, query by
                <b class="primary--text">stratigraphy:Burtnieki*</b> will search
